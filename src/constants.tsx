...
export const WEDDING_CONFIG: WeddingConfig = {
  couple: {
    bride: {
      ...
      parents: "Putri ke ... dari Bapak ... & Ibu ...",
    ...
    groom: {
      ...
      parents: "Putra ke ... dari Bapak ... & Ibu ...",
  ...
  venue: {
    ...
    address: "Jl. Elok No. 77, Kab. Pandeglang, Banten",
    latitude: -6.2088,
    longitude: 106.8456,
  },
  events: {
    akad: {
      ...
      startTime: "08:00",
      endTime: "10:00",
      startDateTime: new Date("2025-10-11T08:00:00+07:00"),
      endDateTime: new Date("2025-10-11T10:00:00+07:00"),
    },
    resepsi: {
      ...
      startTime: "11:00",
      endTime: "14:00",
      startDateTime: new Date("2025-10-11T11:00:00+07:00"),
      endDateTime: new Date("2025-10-11T14:00:00+07:00"),
    },
  },
};
...
export const GALLERY_IMAGES = [
  ...
  "https://placehold.co/1200x800?text=Moment+9",
];
